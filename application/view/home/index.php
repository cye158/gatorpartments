...
<div class="row">
	...
	<!-- listing -->
	<div class="col-sm-7" style="border-radius: 0px; margin-bottom: 0px;">
	...
	<div class="col-sm-5 row">
		...
		<div class="row">
			<div class="col-sm-12 col-xs-6 ad">
				<img src="http://i4.mirror.co.uk/incoming/article4773907.ece/ALTERNATES/s615b/Coca-Cola-christmas.jpg" style="height: 100%; width:100%;">
			</div>
		</div>
		<!-- /ads -->
