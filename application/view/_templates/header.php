										...
										<li>
											<a style="height: 2.85em;border-right: 2.5px solid #444444;border-left: none;padding-left: 1em;padding-right: 1em;">
												<form name="searchbox" method="post" action="<?php echo URL;?>home/listings">
													...
													<input type="submit" src=url("/img/search-icon.png") name="submitSearch" style="background-repeat: no-repeat; background-size: 27.5px 27.5px; background-position: center center; margin-left: 2.5px; padding: 2.5px; border: 1.5px solid #888; border-radius: 30px; background-color: #555;">
												</form>
											</a>
										</li>
										<li></li>
